        ...
        <Row>
          <Col>
            <div className="games-bx">
              <h2>Games Forplay</h2>
              <p>text text here
                <b>text text heretext text heretext text heretext text heretext text here</b>
              </p>
              <div className='carousel-bx'>
                <Carousel autoPlay={true} autoPlaySpeed={2000} responsive={responsive} infinite={true} className="games-slider" >
                  {
